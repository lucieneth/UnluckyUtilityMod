...
>
> **Last synced:** v2.1 + NewModules Phase 0/1 through the targeting/projectile foundations
> (`ServerVisibility`/Panic, the inventory/offhand/damage owners, survival safety, BetterChat,
> VeinMiner, Scaffold, `TargetingUtil`, `ProjectilePathUtil`, `ProjectileAimSolver`)
